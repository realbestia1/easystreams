    ...
    if (normalizedType === 'movie') {
        if (isKitsuRequest) {
            ...
            plan = likelyAnime
                ...
                : ['streamingcommunity', 'guardahd', 'guardoserie', 'altadefinizionestreaming', 'vidxgo', 'cinemacity'];
        } else if (likelyAnime || ENABLE_ANIME_FALLBACK_ON_MOVIES) {
            plan = ['animeunity', 'animeworld', 'animesaturn', 'guardoserie'];
        } else {
            plan = ['streamingcommunity', 'guardahd', 'guardoserie', 'altadefinizionestreaming', 'vidxgo', 'cinemacity'];
        }
        ...
        if (isImdbRequest) {
            plan = likelyAnime
                ...
                : ['streamingcommunity', 'guardoserie', 'altadefinizionestreaming', 'vidxgo', 'cinemacity'];
        } else if (likelyAnime || ENABLE_ANIME_FALLBACK_ON_SERIES) {
            plan = ['animeunity', 'animeworld', 'animesaturn', 'guardoserie', 'vidxgo'];
        } else {
            plan = ['streamingcommunity', 'guardoserie', 'altadefinizionestreaming', 'vidxgo', 'cinemacity'];
        }
    }
